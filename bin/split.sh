...
declare -A dirs_to_repos=(["Api"]="api" ["ApplicationBuilders"]="application-builders" ["Collections"]="collections" ["Configuration"]="configuration" ["Console"]="console" ["DependencyInjection"]="dependency-injection" ["Exceptions"]="exceptions" ["Framework"]="framework" ["IO"]="io" ["Middleware"]="middleware" ["Net"]="net" ["Reflection"]="reflection" ["Router"]="router" ["Serialization"]="serialization" ["Sessions"]="sessions" ["Validation"]="validation")
