...
class GlobalConfigurationTest extends TestCase
{
    ...
    {
        GlobalConfiguration::setInstance(new Configuration(['foo' => false]));
        $value = null;
