...
namespace Aphiria\Configuration\Framework\Validation\Builders;
...
/**
 * Defines the object constraints component builder
 */
final class ObjectConstraintsBuilder implements IComponentBuilder
{
