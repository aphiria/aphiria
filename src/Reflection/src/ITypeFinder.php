...
interface ITypeFinder
{
     ...
     * @return string[]|class-string[] The list of all class names
     ...
     * @param string|string[] $directories The path or list of paths of directories to search
     * @param bool $recursive Whether or not we want to recurse through all directories
     * @return string[]|interface-string[] The list of all interface names
     * @throws InvalidArgumentException Thrown if the paths are not a string or array of strings
     */
     ...
     * @param string|string[] $directories The path or list of paths of directories to search
     * @param bool $recursive Whether or not we want to recurse through all directories
     * @return string[]|class-string[] The list of all types that are sub-types of the input class/interface
     * @throws InvalidArgumentException Thrown if the paths are not a string or array of strings
     ...
     * @param string|string[] $directories The path or list of paths of directories to search
     * @param bool $recursive Whether or not we want to recurse through all directories
     * @return string[]|class-string[]|interface-string[] The list of all types
     * @throws InvalidArgumentException Thrown if the paths are not a string or array of strings
     */
