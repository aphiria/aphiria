...
/**
 * Defines a 301 response factory
 */
class MovedPermanentlyResponseFactory extends ResponseFactory
{
    /**
     * @inheritdoc
    ...
    public function __construct($uri, HttpHeaders $headers = null, $body = null)
    {
        ...
        parent::__construct(HttpStatusCodes::HTTP_MOVED_PERMANENTLY, $headers, $body);
