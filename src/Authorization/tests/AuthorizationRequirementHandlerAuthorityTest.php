...
class AuthorizationRequirementHandlerAuthorityTest extends TestCase
{
    private AuthorizationRequirementHandlerAuthority $authority;
    ...
    protected function setUp(): void
    {
        ...
        $this->authority = new AuthorizationRequirementHandlerAuthority($this->policies, $this->requirementHandlers, false);
    }
    ...
    public function testAuthorizingResourcePassesResourceToRequirementHandlers(): void
    {
        ...
        $user = $this->createMock(IPrincipal::class);
        /** @var IAuthorizationRequirementHandler<RolesRequirement, AuthorizationRequirementHandlerAuthorityTest>&MockObject $requirementHandler */
    ...
    {
        $authority = new AuthorizationRequirementHandlerAuthority($this->policies, $this->requirementHandlers, true);
        $this->requirementHandlers->registerRequirementHandler(RolesRequirement::class, new RolesRequirementHandler());
        $user = $this->createMock(IPrincipal::class);
        $user->method('getClaims')
            ->with(ClaimType::Role)
