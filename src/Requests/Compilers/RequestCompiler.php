...
/**
 * Defines a base request compiler
 */
abstract class RequestCompiler implements IRequestCompiler
{
    /**
     * Compiles a list of tokens into a request
     *
     ...
     */
    protected function compileTokens(array $tokens): Request
    {
        $commandName = null;
        $argumentValues = [];
        $options = [];
        ...
        return new Request($commandName, $argumentValues, $options);
    }
