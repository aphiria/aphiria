...
/**
 * Defines an element compiler that uses a parser
 */
final class ParserOutputCompiler implements IOutputCompiler
{
    /**
    ...
    public function __construct(
        ...
        private readonly IOutputLexer $lexer = new HtmlLikeOutputLexer(),
        private readonly IOutputParser $parser = new HtmlLikeOutputParser()
    ) {
    }
