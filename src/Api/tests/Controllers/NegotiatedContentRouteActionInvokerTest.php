...
class RouteActionInvokerTest extends TestCase
{
    ...
    private NegotiatedContentRouteActionInvoker $invoker;
    ...
    protected function setUp(): void
    {
        ...
        $this->invoker = new NegotiatedContentRouteActionInvoker(
    ...
    public function testInvokingRouteActionWithUnreflectableRouteActionDelegateThrowsException(): void
    {
        ...
        $routeActionInvoker = new class () extends NegotiatedContentRouteActionInvoker {
