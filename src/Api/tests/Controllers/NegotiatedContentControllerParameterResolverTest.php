...
class NegotiatedContentControllerParameterResolverTest extends TestCase
{
    private NegotiatedContentControllerParameterResolver $resolver;
    ...
    protected function setUp(): void
    {
        ...
        $this->resolver = new NegotiatedContentControllerParameterResolver($this->contentNegotiator);
    }
