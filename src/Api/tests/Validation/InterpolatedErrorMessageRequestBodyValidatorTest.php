...
class InterpolatedErrorMessageRequestBodyValidatorTest extends TestCase
{
    ...
    private InterpolatedErrorMessageRequestBodyValidator $requestBodyValidator;
    ...
    protected function setUp(): void
    {
        ...
        $this->requestBodyValidator = new InterpolatedErrorMessageRequestBodyValidator(
            $this->validator,
