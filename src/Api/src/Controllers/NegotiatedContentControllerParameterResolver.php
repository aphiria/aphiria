...
/**
 * Defines the negotiated content controller parameter resolver
 */
final class NegotiatedContentControllerParameterResolver implements IControllerParameterResolver
{
    /**
