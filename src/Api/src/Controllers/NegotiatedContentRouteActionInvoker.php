...
/**
 * Defines the negotiated content route action invoker
 */
class NegotiatedContentRouteActionInvoker implements IRouteActionInvoker
{
    ...
    public function __construct(
        IContentNegotiator $contentNegotiator = new MediaTypeFormatterContentNegotiator(),
        ...
        $this->controllerParameterResolver = $controllerParameterResolver ?? new NegotiatedContentControllerParameterResolver($contentNegotiator);
    }
