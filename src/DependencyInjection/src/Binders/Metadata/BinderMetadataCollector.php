 ...
 */
final class BinderMetadataCollector implements IContainer
{
    /** @var null The value of an empty target */
    private const EMPTY_TARGET = null;
    /** @var Binder The binder whose metadata is being collected */
    ...
    /**
     * @param Binder $binder The binder whose metadata is being collected
     * @param IContainer $container The underlying container to use to resolve and bind instances
     */
    public function __construct(Binder $binder, IContainer $container)
    {
        $this->binder = $binder;
    ...
    /**
     * Gets the binder whose metadata we're collecting
     *
    ...
    /**
     * Gets the list of bound interfaces from the binder
     *
    ...
    /**
     * Gets the list of resolved interfaces from the binder
     *
