...
/**
 * Defines the reflection dependency injection container
 */
class ReflectionContainer implements IContainer
{
    /**
     ...
     *
     * @var ReflectionContainer|null
     */
    public static ?ReflectionContainer $globalInstance = null;
