...
/**
 * Defines the content negotiator that uses media type formatters
 */
final class MediaTypeFormatterContentNegotiator implements IContentNegotiator
{
    ...
    public function __construct(
        ...
        $this->mediaTypeFormatterMatcher = $mediaTypeFormatterMatcher ?? new RequestHeaderMediaTypeFormatterMatcher($this->mediaTypeFormatters);
    }
