...
/**
 * Defines the proxy for validator builders so that they don't have to be instantiated until after bootstrappers are run
 */
final class ValidatorBuilderProxy extends ValidatorBuilder implements IComponentBuilderProxy
{
    ...
    {
        $this->proxiedCalls[] = fn (ValidatorBuilder $validatorBuilder) => $validatorBuilder->withAnnotations();
    ...
    {
        $this->proxiedCalls[] = fn (ValidatorBuilder $validatorBuilder) => $validatorBuilder->withObjectConstraints($callback);
