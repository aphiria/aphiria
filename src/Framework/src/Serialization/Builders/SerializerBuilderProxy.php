...
/**
 * Defines the proxy for serializer builders so that they don't have to be instantiated until after bootstrappers are run
 */
final class SerializerBuilderProxy extends SerializerBuilder implements IComponentBuilderProxy
{
    ...
    {
        $this->proxiedCalls[] = fn (SerializerBuilder $serializerBuilder) => $serializerBuilder->withEncoder($class, $encoder);
