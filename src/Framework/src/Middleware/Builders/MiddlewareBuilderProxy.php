...
/**
 * Defines the proxy for middleware builders so that they don't have to be instantiated until after bootstrappers are run
 */
final class MiddlewareBuilderProxy extends MiddlewareBuilder implements IComponentBuilderProxy
{
    ...
    {
        return MiddlewareBuilder::class;
    }
