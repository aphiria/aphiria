...
use Aphiria\Framework\DependencyInjection\Builders\ExceptionHandlerBuilderProxy;
...
/**
 * Defines a module builder base class with convenience methods for building applications
 */
abstract class ModuleBuilder implements IModuleBuilder
{
     ...
     */
    protected function withBootstrappers(IApplicationBuilder $appBuilder, $bootstrappers): self
    {
     ...
     * @return self For chaining
     */
    protected function withGlobalMiddleware(IApplicationBuilder $appBuilder, $middlewareBindings): self
    {
