...
class ProblemDetailsExceptionRendererTest extends TestCase
{
    ...
    /**
     * @return array<list<mixed>> The list of problem details property names, raw values, and expected values
     */
    ...
    public function testCreatingResponseForExceptionWithoutCustomMappingCreatesProblemDetailsWith500Status(): void
    {
        ...
        $this->assertSame(HttpStatusCode::INTERNAL_SERVER_ERROR, $problemDetailsJson['status']);
    ...
    public function testHavingRequestSetButAnExceptionGetsThrownCausesGenericResponse(): void
    {
        ...
        $this->responseWriter->expects($this->once())
            ...
            ->with($this->callback(function (IResponse $response) {
                return $response->getStatusCode() === HttpStatusCode::INTERNAL_SERVER_ERROR
    ...
    {
        $exceptionRenderer = $this->createExceptionRenderer(true, true);
        $expectedResponse = new Response(HttpStatusCode::INTERNAL_SERVER_ERROR);
        $this->responseFactory->expects($this->once())
            ->method('createResponse')
            ->with($this->request, HttpStatusCode::INTERNAL_SERVER_ERROR, null, new ProblemDetails('https://tools.ietf.org/html/rfc7231#section-6.6.1', null, null, HttpStatusCode::INTERNAL_SERVER_ERROR))
    ...
    public function testNotHavingRequestSetCreatesProblemDetailsResponse(): void
    {
        ...
        $this->assertSame(HttpStatusCode::INTERNAL_SERVER_ERROR, $actualResponse->getStatusCode());
