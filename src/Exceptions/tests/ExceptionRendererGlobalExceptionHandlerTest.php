...
class GlobalExceptionHandlerTest extends TestCase
{
    ...
    private ExceptionRendererGlobalExceptionHandler $globalExceptionHandler;
    ...
    protected function setUp(): void
    {
        ...
        $this->globalExceptionHandler = new ExceptionRendererGlobalExceptionHandler($this->exceptionRenderer, $this->logger, $this->logLevelFactory);
    ...
    public function testHandleShutdownThrowsErrorsAsExceptions(): void
    {
        ...
        $globalExceptionHandler = new class ($this->createMock(IExceptionRenderer::class)) extends ExceptionRendererGlobalExceptionHandler {
