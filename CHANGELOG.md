...
- Updated `HashTable::addRange()` parameter to be named `$kvps` ([#344](https://github.com/aphiria/aphiria/pull/344))
...
- Added support for associative arrays in `HashTable` and `ImmutableHashTable` ([#344](https://github.com/aphiria/aphiria/pull/344))
